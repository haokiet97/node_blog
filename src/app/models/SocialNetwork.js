...
const SocialNetwork = new Schema({
    ...
    profileUrl: { type: String, maxLength: 255 },
    userId: { type: String, maxLength: 255 },
    tagId: { type: String, maxLength: 255 },
...
SocialNetwork.query.sortable = function (req) {
...
//ADD plugin
//set plugin softdelete for SocialNetworkModel
SocialNetwork.plugin(mongoose_delete, { deletedAt : true, indexFields: true, overrideMethods: 'all' })
//use plugin slug for mongoose
mongoose.plugin(slugGenerator, slugOptions)

module.exports = mongoose.model("SocialNetwork", SocialNetwork)
